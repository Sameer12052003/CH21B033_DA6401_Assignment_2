...
from Q1 import Custom_CNN, inaturalist_dataset
...
def main():
    ...
    wandb.run.name = f"""filters_{config.filter_config}_act_{config.activation_func}
            _drop_{config.dropout}_bs_{config.batch_size}_ep_{config.epochs}"""
